...
const QUESTIONS = [
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "La representación de los posibles caminos entre dos puntos X e Y se escribe X(n)Y, donde n es el número de caminos. Para caminos de A a B de longitud 25 cm pasando por C: de A a C la longitud debe ser 15 cm y de C a B 10 cm.",
    ...
    level: 4,
    justification:
      "Hay 3 caminos de A a C con 15 cm y 2 caminos de C a B con 10 cm.",
  },
  {
    id: 203,
    simulators: [1],
    ...
    context:
      "Al hacer una encuesta en un curso, se determinó que la mayoría de estudiantes tienen 15 años de edad.",
    ...
    level: 2,
    justification:
      "En la gráfica C la barra más alta está en 13 años (moda = 13).",
  },
  {
    id: 204,
    simulators: [1],
    ...
    context:
      "Dos vidrios iguales de forma cuadrada, cada uno de área x cm², se ponen juntos en una ventana.",
    ...
    options: [
      ...
      "D. falsa, pues el área de la ventana resultante es x² cm⁴.",
    ],
    correct: 0,
    competency: "Argumentación",
    level: 4,
    justification:
      "x + x = 2x. El área total siempre es la suma de las partes.",
  },
  {
    id: 205,
    simulators: [1],
    ...
    context:
      "La gráfica muestra el costo de producción y el precio de venta de un videojuegos en 2010. La tabla muestra el número de videojuegos vendidos por una empresa del año 2008 al 2012.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      'Una tienda fija el anuncio: TV HD 32" → $1.200.000, Nevera 327L → $1.000.000, Lavadora 13kg → $1.100.000, Pague hasta 12 cuotas mensuales sin intereses.',
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Carlos evalúa dos cursos de idiomas: Intensivo (inscripción $100.000, libro $50.000, clase $30.000, descuento 20%) vs Extensivo (inscripción $100.000, libro $50.000, clase $10.000, descuento 10%).",
    text: "La información es insuficiente porque",
    options: [
      "A. no conoce las formas de pago de cada curso.",
      "B. necesita saber la cantidad de clases que ofrece cada curso.",
      "C. no sabe cuánto es el descuento por cada clase.",
      "D. necesita conocer el valor total del curso para aplicar el descuento.",
    ],
    correct: 1,
    competency: "Argumentación",
    level: 3,
    justification:
      "Sin saber cuántas clases tiene cada curso, no se puede calcular el costo total.",
  },
  {
    id: 208,
    simulators: [1],
    subject: "mat",
    context:
      "Se encuestarán 2.000 personas para conocer intención de voto. El 60% de los votantes tienen entre 18 y 38 años; el 40% restante son mayores de 39 años.",
  ...
  },
  {
    ...
    context:
      "En la figura se representa el cuadrilátero MNOP con la medida de algunos de sus lados, ángulos y de una de sus diagonales.",
    ...
    level: 4,
    justification:
      "α y δ son ángulos alternos internos. Como α = δ = 40°, entonces PO ∥ MN.",
  },
  ...
  // SOC - Sociales (9 preguntas)
  {
    ...
    subject: "soc",
    context:
      "La Constitución de 1991 estableció que los gobernadores y alcaldas contraen con sus electores la obligación de cumplir el programa de gobierno que presentaron al inscribirse como candidatos.",
    ...
    options: [
      ...
      "C. se convoque al pueblo para que apruebe o rechace normas del país.",
      "D. el presidente decida si se aprueban las decisiones de los gobernantes.",
    ],
    correct: 1,
    competency: "Pensamiento social",
    level: 2,
    justification:
      "La revocatoria del mandato permite a los ciudadanos revocar un gobernante que incumplió.",
  },
  {
    id: 302,
    simulators: [1],
    subject: "soc",
    context:
      "Empleados de una empresa se quejan permanentemente del alto volumen de ruido que deben soportar a diario en sus instalaciones de trabajo.",
    text: "¿Qué derecho pueden invocar los trabajadores para pedirle a la empresa que tome medidas para disminuir el ruido?",
    options: [
      "A. Tener un acceso equitativo a la salud.",
      "B. Tener un trato justo y equitativo ante la ley.",
      "C. Tener igualdad de oportunidades para trabajar.",
      "D. Tener un entorno ambiental sano.",
    ],
    correct: 3,
    competency: "Pensamiento social",
    level: 2,
    justification:
      "El artículo 79 de la Constitución garantiza el derecho a un ambiente sano.",
  },
  {
    id: 303,
    simulators: [1],
    ...
    level: 4,
    justification:
      "Las ideas de la Revolución cubana y los problemas de tierras sí influyeron en los 60.",
  },
  {
    id: 304,
    simulators: [1],
    subject: "soc",
    context:
      "Un joven de 20 años compra material pornográfico con imágenes de adolescentes menores de edad. Sus padres señalan las implicaciones legales. El joven invoca su mayoría de edad y libertad de consumo.",
    text: "En esta situación se presenta un conflicto porque",
    options: [
      "A. los padres no conocen los derechos sexuales de los jóvenes.",
      "B. los padres tienen en cuenta las implicaciones de la explotación sexual de menores y el joven no.",
      "C. los padres no tienen en cuenta que los menores hacen actividades de manera voluntaria.",
      "D. los padres ven a todos los jóvenes como niños.",
    ],
    correct: 1,
    competency: "Interpretación y análisis de perspectivas",
    level: 2,
    justification:
      "Los padres reconocen el daño de la explotación sexual de menores.",
  },
  {
    id: 305,
    simulators: [1],
    subject: "soc",
    context:
      '<em>Editorial de El Tiempo:</em> "En Rusia y en todos los países sometidos a la órbita despótica, los derechos humanos no han tenido reconocimiento alguno... En contraste, en el mundo libre la Declaración de los Derechos Humanos ha encontrado fervorosa y progresiva aplicación..."',
    ...
    level: 3,
    justification:
      "La oposición entre el modelo soviético y las democracias occidentales sitúa el texto en la Guerra Fría.",
  },
  {
    id: 306,
    simulators: [1],
    subject: "soc",
    context:
      '<em>Comunicado del consulado estadounidense en Santa Marta, diciembre 1928:</em> "El sentimiento contra el Gobierno... es dudoso si podemos depender del gobierno colombiano para la protección..."',
    text: "Esta descripción de las circunstancias previas a la Masacre de las Bananeras puede ponerse en duda porque",
    options: [
      "A. se afirma que el carácter de la huelga ha cambiado sin señalar los aspectos centrales del cambio.",
      "B. es un estadounidense y no un huelguista el que argumenta.",
      "C. se da por sentada una relación entre las Fuerzas Armadas y los huelguistas sin aportar evidencias.",
      "D. las comunicaciones entre cónsules debían tener el visto bueno del Gobierno colombiano.",
    ],
    correct: 2,
    competency: "Interpretación y análisis de perspectivas",
    level: 3,
    justification:
      "La fuente afirma que soldados simpatizan con huelguistas sin aportar evidencia.",
  },
  {
    id: 307,
    simulators: [1],
    ...
    options: [
      "A. Construir más vías disminuye la velocidad de circulación.",
      "B. Construir más vías genera más contaminación.",
    ...
    level: 2,
    justification:
      "La contaminación adicional es un efecto no deseado ni planeado.",
  },
  {
    id: 308,
    simulators: [1],
    subject: "soc",
    context:
      "El Derecho Internacional Humanitario (DIH) protege a personas que no toman parte en las hostilidades: civiles, médicos y religiosos. Regula también la detención de prisioneros de guerra.",
    ...
    options: [
      ...
      "D. Evitar y limitar los conflictos políticos entre grupos opositores.",
    ],
    correct: 1,
    competency: "Pensamiento reflexivo y sistémico",
    level: 3,
    justification:
      "El DIH busca limitar el sufrimiento humano en todos los actores durante conflictos armados.",
  },
  {
    id: 309,
    simulators: [1],
    subject: "soc",
    context:
      '<em>Documento del CONPES (1990):</em> "Los grandes niveles de protección reducen los incentivos para buscar mejoras tecnológicas..."',
    text: "El anterior texto justifica la implementación de una política de apertura económica, porque",
    options: [
      "A. sugiere que la inversión en ciencia y tecnología puede incrementar las exportaciones.",
      "B. describe las ventajas de proteger los sectores económicos con menos recursos.",
      "C. indica que la diversificación de la producción incrementa la inserción en mercados competitivos.",
      "D. señala que proteger la economía nacional desestima la competitividad.",
    ],
    correct: 3,
    competency: "Pensamiento reflexivo y sistémico",
    level: 4,
    justification:
      "El texto critica exactamente que la protección desestima la competitividad.",
  },
  ...
  // CN - Ciencias Naturales (10 preguntas)
  {
    ...
    options: [
      "A. Pérdida de la capacidad de las plantas para realizar su respiración.",
      "B. Incremento en la concentración de este gas en la atmósfera.",
      "C. Pérdida de la concentración de carbón en los combustibles fósiles.",
      "D. Pérdida de las bacterias anaerobias que realizan la descomposición.",
    ],
    correct: 1,
    competency: "Uso comprensivo del conocimiento científico",
    level: 3,
    justification:
      "Mayor emisión de CO₂ resulta en un incremento de su concentración atmosférica.",
  },
  {
    id: 402,
    simulators: [1],
    ...
    context:
      "Las sustancias con el grupo C=O pueden reducirse en presencia de un catalizador M y un medio ácido para formar un alcano.",
    text: "¿Cuál de las siguientes sustancias puede reducirse para formar un alcano de 4 carbonos?",
    options: [
      "A. Sustancia A (alcohol de 4C sin grupo C=O)",
      "B. Sustancia B (molécula con Cl y N, sin C=O)",
      "C. Sustancia C (alcano de 5C, ya reducido)",
      "D. Sustancia D (cetona de 4C con grupo C=O)",
    ],
    correct: 3,
    competency: "Uso comprensivo del conocimiento científico",
    level: 4,
  ...
  },
  {
    ...
    context:
      "Una estudiante pone 4 recipientes con líquidos de diferente masa en una estufa con llamas idénticas. Orden de ebullición: 1, 3, 4, 2.",
    text: "¿Cuál de los líquidos necesitó mayor energía calórica para alcanzar el punto de ebullición?",
    options: [
      "A. El del recipiente 3.",
      "B. El del recipiente 4.",
      "C. El del recipiente 1.",
      "D. El del recipiente 2.",
    ],
    correct: 3,
    competency: "Uso comprensivo del conocimiento científico",
    level: 3,
    justification:
      "El recipiente 2 tardó más tiempo, por tanto absorbió más energía calórica total.",
  },
  {
    id: 404,
    simulators: [1],
    ...
    questionImg: "cn_boya",
    context:
      "Una boya se ata al fondo del mar mediante una cuerda. La boya se mantiene quieta. Las fuerzas son: flotación (↑), peso (↓) y tensión de la cuerda (↓).",
    text: "Puede afirmarse que la boya se mantiene quieta porque",
    options: [
      "A. la fuerza de flotación es igual al peso de la boya sumando la tensión de la cuerda.",
  ...
  },
  {
    ...
    context:
      "Un diagrama de fases muestra las condiciones de presión y temperatura de los estados de un compuesto. En el momento 1: presión P₁ y temperatura T₁. En el momento 2: presión P₂ y temperatura T₂ (ambos en la región sólida).",
    text: "¿Cuál es el estado del compuesto W en el momento 1 y en el momento 2?",
    options: [
      "A. En el momento 1 es sólido y en el momento 2 es líquido.",
      "B. En el momento 1 es sólido y en el momento 2 también es sólido.",
      "C. En el momento 1 es gas y en el momento 2 es sólido.",
      "D. En el momento 1 es líquido y en el momento 2 también es líquido.",
    ],
    correct: 1,
    competency: "Explicación de fenómenos",
    level: 3,
    justification:
      "Ambos puntos permanecen en la región sólida, no hay cambio de estado.",
  },
  {
    id: 406,
    simulators: [1],
    ...
    level: 2,
    justification:
      "El CO₂ es el principal gas de efecto invernadero causado por actividades humanas.",
  },
  {
    id: 407,
    simulators: [1],
    ...
    options: [
      "A. Es contaminante.",
      "B. No depende del clima.",
      "C. Es muy cara de explotar.",
      "D. Tiene alto impacto visual.",
    ],
    correct: 1,
    competency: "Uso comprensivo del conocimiento científico",
    level: 2,
    justification:
      "La energía geotérmica no depende del clima y está disponible constantemente.",
  },
  {
    id: 408,
    simulators: [1],
    ...
    level: 1,
    justification:
      "El pH neutro es 7, valores menores son ácidos y mayores son básicos.",
  },
  {
    id: 409,
    simulators: [1],
    ...
    options: [
      "A. Energía nuclear en energía térmica",
      "B. Energía química en energía eléctrica",
      "C. Energía térmica en energía eléctrica",
      "D. Energía mecánica en energía química",
    ],
    correct: 2,
    competency: "Explicación de fenómenos",
    level: 2,
    justification:
      "La energía geotérmica transforma energía térmica en eléctrica.",
  },
  {
    id: 410,
    simulators: [1],
    ...
    options: [
      "A. Estar compuestos de átomos",
      "B. Realizar reacciones químicas",
      "C. Tener células",
      "D. Ocupar espacio",
    ],
    correct: 2,
    ...
    level: 1,
    justification:
      "Tener células es la característica que define a los seres vivos.",
  },
  ...
  // ING - Inglés (4 preguntas)
  {
    ...
    subject: "ing",
    context:
      'Read the following text and answer the question: "The Amazon rainforest is the largest tropical rainforest in the world. It is located in South America, mainly in Brazil."',
  ...
  // MAT - Matemáticas (20 preguntas)
  {
    ...
    level: 2,
    justification:
      "En la bolsa hay 18 bolas: 3 rojas, 3 negras, 12 blancas. Las probabilidades son 3/18, 3/18, 12/18.",
  },
  {
    id: 1002,
    simulators: [2],
    ...
    level: 2,
    justification:
      "Como el ángulo de inclinación es 4°, el otro ángulo mide 90° - 4° = 86°.",
  },
  {
    id: 1003,
    simulators: [2],
    subject: "mat",
    context:
      "En la tabla se relaciona la cantidad de personas que ingresó cada día durante una semana.",
    ...
    level: 3,
    justification:
      "Total sin reserva: 3100. Total: 7000. Porcentaje: (3100/7000) × 100 ≈ 44%.",
  },
  {
    id: 1004,
    simulators: [2],
    subject: "mat",
    context:
      "El proceso: 1. Sumar personas sin reserva, 2. Multiplicar por 17, 3. Sumar personas con reserva, 4. Multiplicar por 22.5.",
    ...
    level: 2,
    justification:
      "No se pueden calcular ganancias porque no se conocen los gastos.",
  },
  {
    id: 1005,
    simulators: [2],
  ...
  },
  {
    ...
    options: [
      "A. azules se incrementa en seis de una piscina a la siguiente.",
      "B. blancas aumenta en ocho a medida que crece el tamaño.",
      "C. azules es el doble de la cantidad de baldosas blancas.",
      "D. blancas es la tercera parte de las baldosas azules.",
    ],
    correct: 0,
    competency: "Interpretación",
    level: 2,
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Se lanzan cuatro fichas: una azul doble, una blanca doble, y dos mixtas.",
    text: "¿Cuál evento es imposible que ocurra?",
    options: [
      "A. Obtener una cara azul y tres blancas.",
      "B. Obtener dos caras azules y dos blancas.",
      "C. Obtener tres caras azules y una blanca.",
    ...
    level: 3,
    justification:
      "Siempre hay al menos una cara blanca por la ficha blanca doble.",
  },
  {
    id: 1009,
    simulators: [2],
    subject: "mat",
    context:
      "El costo de la boleta según edad: 0-8: $5000, 8-16: $7000, 16-56: $10000, >56: $6000.",
    text: "La gráfica que representa esta función es",
    options: [
      "A. Gráfica escalonada con los cuatro intervalos.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Ángulo M = 150°. Análisis: I. M=150°, N=180°-150°. II. N=30°. III. La suma debe ser 160°.",
    text: "¿En qué paso se comete un error?",
    options: [
      "A. I, porque N debe ser 10°.",
      "B. III, porque la suma debe ser 180°.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Encuesta a 200 clientes: Excelente 10%, Bueno 35%, Regular 40%, Malo 15%.",
    text: "La afirmación verdadera es:",
    options: [
      "A. Más de 30 clientes consideran excelente el servicio.",
      "B. Menos de 50 clientes consideran regular el servicio.",
      "C. Menos de 55 clientes están satisfechos.",
      "D. Más de 60 clientes consideran bueno el servicio.",
    ],
    correct: 3,
    competency: "Argumentación",
    level: 3,
  ...
  },
  {
    ...
    options: [
      ...
      "B. Triángulos congruentes sin intersección.",
      "C. M y N como centros de circunferencias.",
      "D. Dos triángulos equiláteros sobre MN con PQ intersectando MN.",
    ],
    correct: 3,
    competency: "Formulación y ejecución",
    level: 3,
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Plan de 220 minutos. Consumo: 331 minutos. Consumo adicional: 111 minutos.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Diferencia entre valor del minuto del plan y el adicional es $35.42.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Nivel III: 6 horas máximo. Turno 180, llamado cuando tablero muestra 240.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Cuadrilátero se traslada 1 unidad a la izquierda, luego se amplía al doble.",
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Apartamento de $80.000.000 en cuotas: 50×1.600.000, 40×2.000.000, etc.",
    text: "Es verdadero afirmar que",
    options: [
      "A. el empresario paga más por el apartamento dependiendo de las cuotas.",
      "B. a mayor cantidad de cuotas menor valor se pagará en cada una.",
      "C. solo cuando elige el menor número de cuotas paga el valor del apartamento.",
      "D. a mayor valor pagado por cuota, más tiempo se tardará en pagar.",
    ],
    correct: 1,
    competency: "Interpretación",
    level: 2,
    justification:
      "Son inversamente proporcionales: más cuotas = menor valor cada una.",
  },
  {
    id: 1018,
    simulators: [2],
  ...
  },
  {
    ...
    subject: "mat",
    context:
      "Velocidad máxima: 100 km/h. Pilar afirma que en 100 horas avanzará 1 km.",
    text: "La afirmación de Pilar es",
    options: [
      "A. falsa, porque a la velocidad máxima recorrerá 100 km en una hora.",
